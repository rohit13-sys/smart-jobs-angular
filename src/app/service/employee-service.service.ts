...
import { EmployeeEducation, EmployeeExp, EmployeePersonal } from '../pojo/employee';
...
export class EmployeeServiceService {
  ...
  getEmpEducationById(email: any) {
    ...
    const headers = { 'content-type': 'application/x-www-form-urlencoded' }
    return this.http.post<EmployeeEducation>(employeeEducationUrl ,{'headers':headers}).pipe(catchError(this.handleError))
  }
  ...
  getEmpExpById(email: any) {
    ...
    const headers = { 'content-type': 'application/x-www-form-urlencoded' }
    return this.http.post<EmployeeExp>(employeeExpUrl , { 'headers': headers }).pipe(catchError(this.handleError))
  }
